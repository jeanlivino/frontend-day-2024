...
export default function Footer() {
  ...
  return (
    <footer className="lg:relative flex flex-col justify-end items-center bg-black lg:h-56 lg:p-6">
        ...
        <div className="space-y-6 lg:space-y-2">
          ...
          <div className="flex flex-col lg:flex-row w-min whitespace-nowrap items-center gap-12 lg:gap-20">
            ...
            <div className="flex flex-col gap-2 text-center lg:text-left">
              <Link className="hover:underline text-white" href={'ola@frontendce.com.br'}>
                ola@frontendce.com.br
              </Link>
              <Link className="hover:underline text-white" href={'https://wa.me/+5585981361496'}>
                85 98136.1496
              </Link>
            </div>
            <div>
      ...
      <p className="text-white text-center py-12 lg:pb-6 lg:pt-0">&copy; {year} Front-end CE. Todos os direitos reservados.</p>
    </footer>
  )
}